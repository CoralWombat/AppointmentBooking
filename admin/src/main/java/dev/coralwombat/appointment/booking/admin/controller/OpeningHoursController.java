...
import dev.coralwombat.appointment.booking.admin.repository.IOpeningHoursRepository;
...
public class OpeningHoursController implements IOpeningHoursController {
    ...
    @Override
    public void saveOpeningHours(OpeningHoursDTO openingHours) {
        openingHoursRepository.insertOpeningHours(openingHours);
    }

    @Override
    public void deleteOpeningHours(Integer categoryId, DayOfWeek day) {
        openingHoursRepository.deleteOpeningHours(categoryId, day);
    }
